...
class Dataset(object):
    def __init__(self,  patch_size, scale, mode ,dataset ,use_fast_loader=False):
    ...
    def __getitem__(self, idx):
        ...
        lr_down = hr.resize((self.patch_size, self.patch_size), resample=pil_image.BICUBIC)
        lr = lr_down.resize((self.patch_size * self.scale, self.patch_size * self.scale), resample=pil_image.BICUBIC)
