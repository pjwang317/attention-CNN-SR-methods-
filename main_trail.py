...
if __name__ == '__main__':
    ...
    if opt.arch == 'LGCNet':
        ...
        dataset = Dataset(patch_size = opt.patch_size, scale = opt.scale,mode = 'train', dataset = opt.dataset, use_fast_loader = opt.use_fast_loader)
    # print(len(dataset))
    ...
    if opt.arch == 'LGCNet':
        ...
        val_dataset = Dataset( patch_size = opt.patch_size, scale = opt.scale, mode = 'test', dataset = opt.dataset, use_fast_loader = opt.use_fast_loader)
